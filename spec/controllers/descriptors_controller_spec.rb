...
RSpec.describe DescriptorsController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested descriptor as @descriptor" do
      descriptor = Descriptor.create! valid_attributes
      get :show, {:id => descriptor.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested descriptor as @descriptor" do
      descriptor = Descriptor.create! valid_attributes
      get :edit, {:id => descriptor.to_param}, valid_session
      expect(assigns(:descriptor)).to eq(descriptor)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Descriptor" do
        expect {
          post :create, {:descriptor => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved descriptor as @descriptor" do
        post :create, {:descriptor => invalid_attributes}, valid_session
        expect(assigns(:descriptor)).to be_a_new(Descriptor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested descriptor" do
        descriptor = Descriptor.create! valid_attributes
        put :update, {:id => descriptor.to_param, :descriptor => new_attributes}, valid_session
        descriptor.reload
      ...
      it "assigns the requested descriptor as @descriptor" do
        descriptor = Descriptor.create! valid_attributes
        put :update, {:id => descriptor.to_param, :descriptor => valid_attributes}, valid_session
        expect(assigns(:descriptor)).to eq(descriptor)
      end
    ...
    describe "with invalid params" do
      it "assigns the descriptor as @descriptor" do
        descriptor = Descriptor.create! valid_attributes
        put :update, {:id => descriptor.to_param, :descriptor => invalid_attributes}, valid_session
        expect(assigns(:descriptor)).to eq(descriptor)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested descriptor" do
      descriptor = Descriptor.create! valid_attributes
      expect {
        delete :destroy, {:id => descriptor.to_param}, valid_session
      }.to change(Descriptor, :count).by(-1)
    end
